@extends('master')
@section('titlePage', 'Post-Format-Video')
@section('content')
		...
		<!-- Banner starts -->
		<div class="banner banner__single-post banner__single-type-two">
				...
				<div class="post-navigation">
					<div class="post-nav-content">
						<a href="#" class="prev-post">
							<i class="feather icon-chevron-left"></i>Prev Post
						</a>
					</div>
				</div>
				<div class="post-navigation">
				...
				<div class="row">
					...
					<div class="col-lg-8">
						<div class="post-title-wrapper">
							...
							<h2 class="m-b-xs-0 axil-title hover-line color-white m-t-xs-10">VR Is the Use of Computer
								Technology to Create a Simulated Environment.</h2>
										...
										<div class="axil-content">
											...
											<div class="media post-block post-block__small">
												...
												<div class="media-body">
													...
													<div class="post-metas">
														<ul class="list-inline">
															<li>By <a href="{{ route('author')}}{ route('post-format-standard')}}">Xu Jianhong</a>
															</li>
														</ul>
													</div>
												</div>
